...
import org.magmafoundation.magma.craftbukkit.CraftCustomAbstractHorse;
import org.magmafoundation.magma.craftbukkit.CraftCustomChestedHorse;
import org.magmafoundation.magma.craftbukkit.CraftCustomEntity;
import org.magmafoundation.magma.craftbukkit.CraftCustomMinecart;
import org.magmafoundation.magma.craftbukkit.CraftCustomMinecartContainer;
import org.magmafoundation.magma.craftbukkit.CraftCustomMob;
import org.magmafoundation.magma.craftbukkit.CraftCustomProjectileEntity;
import org.magmafoundation.magma.craftbukkit.CraftCustomRaider;
import org.magmafoundation.magma.craftbukkit.CraftCustomSkeleton;
import org.magmafoundation.magma.craftbukkit.CraftCustomThrowableProjectile;
import org.magmafoundation.magma.craftbukkit.CraftCustomVehicle;
import org.magmafoundation.magma.craftbukkit.CraftCustomWindCharge;

/**
 * from https://github.com/IzzelAliz/Arclight/blob/1ddfa61ff2a827809b1c4e623e7137a8195c0265/arclight-common/src/main/java/io/izzel/arclight/common/mod/server/entity/EntityClassLookup.java
 */
public class EntityClassLookup {
    ...
    static {
        ...
        add(AbstractSkeleton.class, new EntityClass<>(org.bukkit.entity.AbstractSkeleton.class, CraftCustomSkeleton.class, CraftCustomSkeleton::new));
        add(Mob.class, new EntityClass<>(org.bukkit.entity.Mob.class, CraftCustomMob.class, CraftCustomMob::new));
        ...
        add(AbstractHorse.class, new EntityClass<>(org.bukkit.entity.AbstractHorse.class, CraftCustomAbstractHorse.class, CraftCustomAbstractHorse::new));
        ...
        add(Projectile.class, new EntityClass<>(org.bukkit.entity.Projectile.class, CraftCustomProjectileEntity.class, CraftCustomProjectileEntity::new));
        add(Raider.class, new EntityClass<>(org.bukkit.entity.Raider.class, CraftCustomRaider.class, CraftCustomRaider::new));
        add(VehicleEntity.class, new EntityClass<>(org.bukkit.entity.Vehicle.class, CraftCustomVehicle.class, CraftCustomVehicle::new));
        add(AbstractWindCharge.class, new EntityClass<>(org.bukkit.entity.AbstractWindCharge.class, CraftCustomWindCharge.class, CraftCustomWindCharge::new));
