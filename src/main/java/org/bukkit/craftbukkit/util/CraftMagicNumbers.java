...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    // ========================================================================
    public static final Map<Block, Material> BLOCK_MATERIAL = new HashMap<>(); // Magma - make public
    public static final Map<Item, Material> ITEM_MATERIAL = new HashMap<>(); // Magma - make public
    public static final Map<Material, Item> MATERIAL_ITEM = new HashMap<>(); // Magma - make public
    public static final Map<Material, Block> MATERIAL_BLOCK = new HashMap<>(); // Magma - make public
