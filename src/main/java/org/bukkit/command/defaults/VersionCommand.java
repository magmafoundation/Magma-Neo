...
public class VersionCommand extends BukkitCommand {
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String currentAlias, @NotNull String[] args) {
        ...
        if (args.length == 0) {
            //sender.sendMessage("This server is running " + Bukkit.getName() + " version " + Magma.getVersion() + " (Implementing API version " + Bukkit.getBukkitVersion() + ", NeoForge Version " + NeoForgeVersion.getVersion() + ")"); // Paper - moved to setVersionMessage
            sendVersion(sender);
        } else {
